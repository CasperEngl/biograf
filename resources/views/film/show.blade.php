          ...
          <div class="my-5">
            ...
            <div class="row">
                ...
                <a href="{{ $cast->contributor->tmdbLink }}" class="col my-1 inline-flex flex-col items-center">
                  <figure class="mb-1">
                    <img src="{{ $cast->contributor->getFirstMediaUrl('profile', 'thumb') }}" alt="{{ $cast->contributor->name }}" class="rounded-full border-2 border-gray-800">
                  </figure>
          ...
          <div class="my-5">
            ...
            <div class="row">
                ...
                <a href="{{ $director->contributor->tmdbLink }}" class="col my-1 inline-flex flex-col items-center">
                    <figure class="mb-1">
                      <img src="{{ $director->contributor->getFirstMediaUrl('profile', 'thumb') }}" alt="{{ $director->contributor->name }}" class="rounded-full border-2 border-gray-800">
                    </figure>
